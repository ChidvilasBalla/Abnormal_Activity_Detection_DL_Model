...
def get_train_test_lists(version='001'):
    ...
    test_file = os.path.join('ucfTrainTestlist', 'test_' + version + '.txt')
    train_file = os.path.join('ucfTrainTestlist', 'train_' + version + '.txt')
...
def move_files(file_groups):
    ...
    for group, videos in file_groups.items():
        ...
        for video in videos:
            ...
            src = os.path.join("UCF_Crimes", classname, filename)
